...
if (!empty($inet_wk_options['inet-webkit-contact-active'])) {
    ...
    function render_html_contact_chanel()
    {
        ...
        $facebook_chat = (!empty($inet_wk_options['inet-webkit-opt-contact']['general-contact']['fanpage-id'])) ? $inet_wk_options['inet-webkit-opt-contact']['general-contact']['fanpage-id'] : "100090216106299";
                            ...
                            <li>
                                <a class="inet-webkit-contact-item inet-webkit-contact-messenger" href="/">
                                    <div class="inet-webkit-contact-icon"><img
                                                ...
                                                alt=""></div>
                                    <div class="inet-webkit-contact-child">
                                        <span class="inet-webkit-contact-child-title">Messengerxxx</span>
                                    </div>
                                </a>
                            </li>
                        <?php endif; ?>
