...
var wpAjaxUrl = 'https://tslabshoespa:8890/wp-admin/admin-ajax.php';var flBuilderUrl = 'https://tslabshoespa:8890/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'https://tslabshoespa:8890/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'https://tslabshoespa:8890/wp-admin/admin-ajax.php'
	},
	breakpoints : {
		small  : 768,
		medium : 992,
...
(function($) {
	...
	jQuery(document).ready(function() {
			...
			$( '.fl-node-5f0eebcb22d79 .uabb-info-list-icon' ).waypoint({
					offset: '90%',
					handler: function( e ) {
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22d74 .uabb-photo-img' )
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22d9d .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22da6 .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22dab .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22da8 .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22dcb .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22e17 .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22e1b .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22e23 .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22e46 .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
	$(function() {
		$( '.fl-node-5f0eebcb22e3f .uabb-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
